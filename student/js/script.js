            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        console.log()
                        return '<a class="me-2 btn btn-sm rounded-0 py-0 edit_data btn-primary" href="javascript:void(0)" data-id="' + (row.id) + '">Edit</a><a class="btn btn-sm rounded-0 py-0 delete_data btn-danger" href="javascript:void(0)" onclick="myFunction()" data-id="' + (row.id) + '">Delete</a>';
                    }
                },
                {
                    data: null,
                    ...
                    render: function(data, type, row, meta) {
                        console.log()
                        return '<img src="" alt="Italian Trulli">';
                    }
                }
            ],
